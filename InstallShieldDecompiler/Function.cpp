...
void CFunction::AddArgument(ArgumentTypeInfo typeInfo)
{
	...
	case ConcreteType::Number:
		m_numbers.push_back(new CVariable(ArgType::NumArg, -1 - m_numbers.size(), true));
	break;
	case ConcreteType::String:
		m_strings.push_back(new CVariable(ArgType::StrArg, -1 - m_strings.size(), true));
	break;
	case ConcreteType::Object:
		m_objects.push_back(new CVariable(ArgType::VariantArg, -1 - m_objects.size(), true));
	break;
	default:
